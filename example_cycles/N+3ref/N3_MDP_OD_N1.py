...
prob.model.set_order(['des_vars', 'T4_ratio', 'TOC', 'CRZ', 'eng_op_limits', 'bal'])
...
for alt in [35000., 30000., 25000., 20000., 15000., 10000., 5000.]:
# for wfuel in [0.6395, 0.60, 0.57, 0.54, 0.51, 0.48]:
